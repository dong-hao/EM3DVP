function Plength=plot_single_profile(aid,x1,x2,y1,y2,x,y,z,SubNv,sitex,...
    sitey,sitez,DAR)
...
plot3(aid,sitey(idx),sitex(idx),sitez(idx)+siteup,...

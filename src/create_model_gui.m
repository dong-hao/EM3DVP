...
hpopEdit_Res=uicontrol(hpedit,'style','popup','units','normalized','position',...
    ...
    'Edit Resist.|Area res.|Layer res.|Half space|Polygon res.|Sphere res.|Checker Board|Add Bathy.|Add Topo+Bathy.|Random layer|Random sigma|123|1d average|area Anis.|boundary',...
    'backgroundcolor',disable_color,...
    'tag','Set Resist.',...
    'enable','off');
...
htMem=uicontrol(hfstatus,'style','text','units','normalized','position',...
    [0.05 0.3 0.7 0.15],'string','Memory required (for G-N methods): ','horizontalalignment',...
    'left','backgroundcolor',[0.5 0.5 1]);

...
hpopEdit_Res=uicontrol(hpedit,'style','popup','units','normalized','position',...
    ...
    'Edit Resist.|Area res.|Layer res.|Half space|Polygon res.|Sphere res.|Checker Board|Add Bathy.|Add Topo+Bathy.|Random layer|Random sigma|123|1d average|area Anis.|tear',...
    'backgroundcolor',disable_color,...
    'tag','Set Resist.',...
    'enable','off');

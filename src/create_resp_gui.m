...
hcboxresp=uicontrol(hbgedit,'style','checkbox','units','normalized','position',...
    [0.05 0.6 0.45 0.25],'string','disp resp','tag','plot resp', ...
    'backgroundcolor',bcolor,'tooltipstring','plot resp');
hcboxerror=uicontrol(hbgedit,'style','checkbox','units','normalized','position',...
    [0.05 0.2 0.45 0.25],'string','disp errorbar','tag','plot errorbar', ...
    'backgroundcolor',bcolor,'tooltipstring','plot errorbar');
